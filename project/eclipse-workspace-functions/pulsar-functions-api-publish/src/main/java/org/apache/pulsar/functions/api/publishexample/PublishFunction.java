...
public class PublishFunction implements Function<String, Void> {
	...
	private static final Logger LOGGER = Logger.getLogger(PublishFunction.class);
	    ...
	    //String output = String.format("%s!", input);
         Gson gson = new Gson();
         //MessageInputContext inputObject = new MessageInputContext();
         //inputObject.context=context;
         //inputObject.message=input;
     	//String outputString = 
	...
	*/
    ...
    public Void process(String input, Context context) {
        ...
        //String output = String.format("%s", input);
    	Gson gson = new Gson();
    	EntitiesPulsarTest inputObject = gson.fromJson(input, EntitiesPulsarTest.class);
        //LOGGER.info("Message received: "+input);
        
        //LOGGER.info("Model class Object Json,"+gson.toJson(inputObject));
        
        //LOGGER.info("Model class object.."+gson.toJson(Schema.AVRO(EntitiesPulsarTest.class)));
        ...
        try {
        	...
        	Producer<EntitiesPulsarTest> producer = 
					client.newProducer(Schema.AVRO(EntitiesPulsarTest.class))
			        .topic(publishTopic)
			        .create();        	
